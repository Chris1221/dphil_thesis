...
In the chromosomal translocaiton event, many of the functional domains of the MLL protein are lost, including four PHD fingers and the SET domain, leaving three AT hooks and the CXXC to determine the binding preferences (\Cref{fig:mll_fig})
...
%We perform \gls{atac} on four childhood leukemia patient samples from the \gls{ukbb} as well as two cellular models of MLL-AF4 leukemia, RS411 and SEM. Details of the processing of these samples and the maintenance of cell lines is available in the Methods section. We collect three Pre-ProB (PPB) and three ProB samples from previous work and download coverage data from the Gene Expression Omnibus (GEO) \cite{OByrne2019}.  

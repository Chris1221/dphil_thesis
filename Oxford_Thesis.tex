...
\def\E{\mathbb{E}}
\def\EM{{\mathsf{{\small EM}}}}
\def\VB{{\mathsf{{\small VB}}}}
\def\F{{\mathcal{F}}}
\def\P{{\mathcal{P}}}
\def\seq{{\cdot\kern-0.5pt\cdot}}
\def\SMCSMC{{\tt SMCSMC} }
\def\Time{time\xspace}
\def\Times{times\xspace}

% For short captions by default
...
\title{Machine Learning Methods for Next Generation Sequencing Data: Applications to MLL-AF4 Leukemia and Demographic Inference}
...
\newpage
\section*{Clarification on Contributions}
...
Some of the text in this thesis has been previously published. Specifically, some expositional text in the introduction is published in \fullcite{10.1371/journal.pone.0247647}, and the majority of Chapter 3 is published in \fullcite{Cole2020}. 
...
%\include{text/chapter2_smc}
\include{text/chapter3_bm}
\include{text/chapter4_tm}
\include{text/chapter5_mll}
%\include{text/chapter5_mll-diffHEAD^1}
\include{text/chapter6_discussion.tex}
...
\include{text/demographic_models}
